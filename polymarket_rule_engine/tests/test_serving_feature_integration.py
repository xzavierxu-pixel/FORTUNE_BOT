...
class ServingFeatureIntegrationTest(unittest.TestCase):
    def test_build_feature_table_keeps_serving_features_for_training(self) -> None:
        ...
        self.assertIn("q_full", out.columns)
        self.assertIn("edge_full", out.columns)
        self.assertNotIn("fine_feature_q_full", out.columns)
        self.assertNotIn("fine_feature_edge_full", out.columns)
        self.assertNotIn("fine_feature_rule_price_width", out.columns)
        ...
        self.assertEqual(float(out.loc[0, "q_full"]), 0.63)
        self.assertEqual(float(out.loc[0, "edge_full"]), 0.18)
