...
# BalanceProvider will be imported from execution_engine.connectors.balance_provider
...
def check_basic_risk(
    ...
    if abs(amount_usdc - cfg.order_usdc) > 1e-9:
        return False, "ORDER_SIZE_MISMATCH"
