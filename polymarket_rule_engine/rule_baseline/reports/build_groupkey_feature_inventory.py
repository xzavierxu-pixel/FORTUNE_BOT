...
def _infer_window(feature_name: str) -> str:
    if "recent_90days" in feature_name:
        return "recent_90days"
...
def _pending_rows() -> list[dict[str, str]]:
    rows = [
        {
            "feature_name": "full_group_recent_90days_vs_expanding_bias_zscore",
            "feature_family": "drift_gap",
            "grain": "full_group_key",
            "window": "recent_90days_vs_expanding",
        ...
        {
            "feature_name": "full_group_recent_90days_vs_expanding_logloss_zscore",
            "feature_family": "drift_gap",
            "grain": "full_group_key",
            "window": "recent_90days_vs_expanding",
            "source_table": "planned_group_serving_features",
...
def _parse_blueprint_rows() -> list[dict[str, str]]:
    ...
    if not blueprint_path.exists():
        blueprint_path = _legacy_docs_dir() / "polymarket_groupkey_500_feature_blueprint.md"
    if not blueprint_path.exists():
        return []
